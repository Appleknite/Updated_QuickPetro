...
const AboutPage = () => {
  return (
    <>
      <Helmet>
        <title>About Us | QuickPetro</title>
        <meta
          name="description"
          content="Learn about QuickPetro's expertise in thermal fluid system solutions, providing industrial cleaning, maintenance, and optimization services for over 30 years."
        />
      </Helmet>
